...
March 7
Lab 9
This program is a bag class that contains the root node of a binary search tree.
*/
...
#pragma mark - Toolkit Function Implementation
    ...
    // of the target were removed.
    {
        ...
        {   // Continue looking in the left subtree
            ...
            if (bst_remove(root_ptr->left(), target)) 
        ...
        {   // Continue looking in the right subtree
            ...
            if (bst_remove(root_ptr->right(), target))
                return 1 + bst_remove_all(root_ptr, target);
        }
...
#pragma mark - Member Function Implementation
    ...
    // method.
    {
        while (addroot_ptr != NULL)
        {
            insert(addroot_ptr);
            Item removed;
            bst_remove_max(addroot_ptr, removed);
